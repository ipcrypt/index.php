<?php
//-------------------------------CONFIG-------------------------------
define('API_KEY','1458548866:AAFd26HSGLj55D5Er7qNcCF8iIC5fAwchi4');
$admin = '1206096242';
//--------------------------------------------------------------------
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"Hi welcome! please know that this is a demo bot please join @ipworksdev to get a copy*
",
'parse_mode'=>"HTML",
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"*this bot was made by @ipworks*",
'parse_mode'=>"HTML",
'reply_to_message_id'=>$message_id,
'reply_markup'=>$back,
]); 
...
bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=>"*Your message is sent to  our moderators*!",
'parse_mode'=>"HTML",
'reply_to_message_id'=>$message_id,
'reply_markup'=>$or,
]); 
...
bot('sendMessage',[
'chat_id'=>$admin,
'text'=>"your message is successfully Message sent!",
'parse_mode'=>"HTML",
]);
}
}
